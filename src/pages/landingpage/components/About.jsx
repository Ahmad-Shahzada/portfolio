    ...
    <div id="about" className="pt-5 bg-white dark:bg-gradient-to-r from-[#0a0a0a] via-[#0d1b34] to-[#020202]">
      <Sectionwraper>
        <div className="container px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row items-center text-black dark:text-white py-20">
              ...
              <section>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
                  {[
                    ...
                    <motion.div
                      key={index}
                      className="bg-gray-100 dark:bg-gray-800 p-6 rounded-xl shadow-xl hover:shadow-2xl transition duration-300"
